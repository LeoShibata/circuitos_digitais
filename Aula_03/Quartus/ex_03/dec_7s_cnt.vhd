...
architecture decode of dec_7s_cnt is
    ...
    component divisor_50M
        PORT (
            clock : IN STD_LOGIC;
            cout  : OUT STD_LOGIC -- pulso de 1 segundo
        );
    end component;
...
begin
	 ...
	 div: divisor_50M port map (clock => clk, cout => pulse_1s);
	 cnt: cnt_1s port map (clock => pulse_1s, aclr => not clr, q => cnt_i);
